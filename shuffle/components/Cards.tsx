...
const Cards = ({ onNewComment }: CardsProps) => {
  const [cards, setCards] = useState<CardContent[]>([
    ...
    },
    {
      ...
      comment:
        "Some people are jealous, some aren't. It's not more virtuous to be less jealous. But it's not more virtuous to be more jealous either. Virtue is not a competition.",
    },
    {
      cardId: "4",
      author: {
