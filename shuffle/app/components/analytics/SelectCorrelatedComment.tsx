    ...
    query === ""
      ...
      : correlatedComments.filter((correlation) => {
          const description = `${correlation.key} ${
            commentIdToCommentMap[correlation.commentA].text
          } ${commentIdToCommentMap[correlation.commentB].text}`;
                ...
                {({ active, selected }) => (
                  <>
                    <div className="flex flex-col">
                      ...
                      >
                        <ChoiceBadge choice={correlation.commentAValence} />{" "}
                        {commentIdToCommentMap[correlation.commentA].text}
                      </span>
                      ...
                      >
                        <ChoiceBadge choice={correlation.commentBValence} />{" "}
                        {commentIdToCommentMap[correlation.commentB].text}
                      </span>
                    </div>
